...
import com.example.mysmallworld.ui.StoryCard;

	public class ListViewAdapter extends ArrayAdapter<Experience> {

        public ListViewAdapter(Activity activity, List playlist) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                Experience card = getItem(position);
